...
@section('header')
    <h1 class="page-header">
        Find errors for {{$name_code}}
        <a href="{{route('backend.manager.author.find-errors.create', ['ST' , $class_code])}}" target="_blank"
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="table-responsive" id="reload_table_ans_for_students">
                        @include('backend.author.find_errors.table-students-index')
                    </div>

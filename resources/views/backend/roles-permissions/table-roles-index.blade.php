<table class="table  table-hover" id="manager_roles">
    <thead>
    <tr>
        <th>STT</th>
        <th>Name</th>
    ...
    @foreach($roles as $role)
        <tr class="odd gradeX">
            ...
            <td>
                <!-- nút hiện form sửa -->
                <button class="btn btn-sm btn-primary" id="btn-edit-role">
                ...
                <button class="btn btn-sm btn-danger" id="role_{{$role->id}}" title="Delete"
